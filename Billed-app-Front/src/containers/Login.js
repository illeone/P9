...
export default class Login {
  ...
  handleSubmitAdmin = e => {
    ...
    const user = {
      type: "Admin",
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`).value,         /*modification id*/
      password: e.target.querySelector(`input[data-testid="admin-password-input"]`).value,   /*modification id*/
      status: "connected"
    }
    this.localStorage.setItem("user", JSON.stringify(user))
    this.login(user)
